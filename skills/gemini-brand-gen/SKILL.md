...
## BrandKit (AI Engineering — Stand 2026-03-05)

> Referenz: `Playbook01/media/assets/BrandKit.png`

| Token | Wert |
|-------|------|
| Primary Accent | `#4263FF` (Blau) |
| Secondary Accent | `#9A25EA` (Lila) |
| Background | `#0A0B14` (Sehr dunkles Navy) |
| Font Heading | Montserrat |
| Font Body | Inter |
| Logo | Eagle (weiss, für dunkle Hintergründe) |

**Produkt-spezifische Akzentfarben** überschreiben den Primary-Accent — siehe `brand_kit_default.json`.
